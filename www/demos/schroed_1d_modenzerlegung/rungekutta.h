...
typedef struct{void** zustand_alt; void** zustand_neu; int ordnung; void** tempvektoren; size_t sizeofvector; paramvektorwandel aenderung; paramvektorwandel adiereauf; float* rungematrix; float zeitschritt;} rungekuttadetails;
fdek(rungekutta, arbeiter, rungekuttadetails, void*, int);

arbeiter macherungekutta_neu(void** zustand_alt, void** zustand_neu, int ordnung, size_t sizeofvector, paramvektorwandel aenderung, paramvektorwandel adiereauf, float* rungematrix, float zeitschritt, zersetzungsplan * muell);
