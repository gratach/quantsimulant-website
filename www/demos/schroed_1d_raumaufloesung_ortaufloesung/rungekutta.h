...
//arbeiter macherungekutta_neu(void** zustand_alt, void** zustand_neu, int ordnung, size_t sizeofvector, paramvektorwandel aenderung, paramvektorwandel adiereauf, float* rungematrix, float zeitschritt);
